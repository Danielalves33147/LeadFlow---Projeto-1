...
public final class UserDTOs {
    ...
    public record UserResponse(
        Long id, String name, String email, UserRole role, UserStatus status,
        Long primaryBranchId, String primaryBranchName, Long managerId, String managerName,
        List<Long> authorizedBranchIds, long activeLeads, Instant lastLoginAt, Instant createdAt
    ) {}
