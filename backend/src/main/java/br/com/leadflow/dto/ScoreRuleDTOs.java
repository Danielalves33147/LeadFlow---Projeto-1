...
public final class ScoreRuleDTOs {
    ...
    public record ScoreRuleStatusRequest(@NotNull ScoreRuleStatus status) {}

    public record ScoreRuleResponse(
        Long id, String name, InteractionType interactionType, ScoreOperation operation,
        int value, ScoreRuleStatus status, Instant updatedAt
    ) {}
}
