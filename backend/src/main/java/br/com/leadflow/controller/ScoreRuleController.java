...
public class ScoreRuleController {
    ...
    public ScoreRuleController(ScoreRuleService service) {
    ...
    @PostMapping
    public ApiResponse<?> create(@Valid @RequestBody ScoreRuleRequest request) {
    ...
    public ApiResponse<?> update(
        ...
        @Valid @RequestBody ScoreRuleRequest request
    ) {
    ...
    public ApiResponse<?> status(
        @PathVariable Long id,
        @Valid @RequestBody ScoreRuleStatusRequest request
    ) {
