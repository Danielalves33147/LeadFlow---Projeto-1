...
public class BranchController {
    ...
    public ApiResponse<?> list(
        ...
        return ApiResponse.of(service.list(from, to));
    }
    ...
    public ApiResponse<?> get(
        ...
        return ApiResponse.of(service.get(id, from, to));
    }

    @PostMapping
    public ApiResponse<?> create(@Valid @RequestBody BranchRequest request) {
        return ApiResponse.of(service.create(request));
    }

    @PutMapping("/{id}")
    public ApiResponse<?> update(@PathVariable Long id, @Valid @RequestBody BranchRequest request) {
