...
public class Interaction extends BaseEntity {
    ...
    public void setChannel(InteractionChannel channel) { this.channel = channel; }
    public InteractionType getType() { return type; }
    public void setType(InteractionType type) { this.type = type; }
    public String getNotes() { return notes; }
    public void setNotes(String notes) { this.notes = notes; }
    public int getScoreApplied() { return scoreApplied; }
    public void setScoreApplied(int scoreApplied) { this.scoreApplied = scoreApplied; }
    public String getScoreRuleName() { return scoreRuleName; }
    public void setScoreRuleName(String scoreRuleName) { this.scoreRuleName = scoreRuleName; }
}
