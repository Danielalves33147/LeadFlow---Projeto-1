...
public interface InteractionDAO extends JpaRepository<Interaction, Long>, JpaSpecificationExecutor<Interaction> {
    ...
    List<Interaction> findByLeadBranchIdAndCreatedAtBetweenOrderByCreatedAtAsc(Long branchId, Instant from, Instant to);
    ...
    Long sumScoreAppliedByBranchBetween(@Param("branchId") Long branchId, @Param("from") Instant from, @Param("to") Instant to);
}
